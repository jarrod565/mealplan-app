  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-3 text-muted-foreground min-h-[50vh]">
          <Loader2 className="w-8 h-8 animate-spin text-primary" />
          <p className="text-sm font-medium">Finding your recipes…</p>
        </div>
      ) : status === 'error' ? (
        <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4 text-center px-6 max-w-xs mx-auto">
        ...
        <div className="relative flex-1 min-h-[60vh] mx-4 mt-3 mb-5 md:mx-auto md:w-full md:max-w-[420px] md:mt-6 md:mb-8">
...
function NoActiveSourcesEmptyState({ onOpenFilter }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[65vh] px-6 text-center gap-5">
      ...
      <Button onClick={onOpenFilter} className="w-full gap-2">
        <SlidersHorizontal className="w-4 h-4" />
        Open Filter
      </Button>
    </div>
...
function PoolExhaustedState({ onChangeFilters, onStartOver }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[65vh] px-6 text-center gap-4">
